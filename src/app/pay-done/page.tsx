    ...
    return (
      <div className="w-full flex flex-col sm:rounded-2xl space-y-10 px-0 sm:p-6 xl:p-8">
        ...
        <div className="space-y-6">
          <h3 className="text-2xl font-semibold">Buyurtmangiz</h3>
        ...
        {/* ------------------------ */}
        <div className="space-y-6">
          <h3 className="text-2xl font-semibold">Buyurtma tafsilotlari</h3>
          <div className="flex flex-col space-y-4">
            <div className="flex text-neutral-6000 dark:text-neutral-300">
              <span className="flex-1">Buyurtma kodi</span>
              <span className="flex-1 font-medium text-neutral-900 dark:text-neutral-100">
                #222-333-111
              </span>
            </div>
            <div className="flex text-neutral-6000 dark:text-neutral-300">
              <span className="flex-1">Sana</span>
              <span className="flex-1 font-medium text-neutral-900 dark:text-neutral-100">
                12 Aug, 2021
              </span>
            </div>
            ...
            <div className="flex justify-between text-neutral-6000 dark:text-neutral-300">
              <span className="flex-1">To‘lov usuli</span>
              <span className="flex-1 font-medium text-neutral-900 dark:text-neutral-100">
                Credit card
              </span>
            </div>
        ...
        <div>
          <ButtonPrimary href="/">Ko‘proq turar joylarni ko‘rish</ButtonPrimary>
        </div>
      </div>
    );
  };

...
const SectionGridAuthorBox: FC<SectionGridAuthorBoxProps> = ({
  ...
  return (
    ...
    >
      <Heading desc="Mijozlar fikriga asoslangan reyting" isCenter>
        Oy bo'yicha eng yaxshi 10 ta muallif
      </Heading>
      ...
      <div className="mt-16 flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-5">
        <ButtonSecondary loading>Yana ko‘proq ko‘rsatish</ButtonSecondary>
        <ButtonPrimary>Mehmonxona egasi bo‘ling</ButtonPrimary>
      </div>
    </div>
  );
};
